...
{
    public class LiteListView : LiteControl
    {
        ...
        public List<LiteListViewItem> Items { get; } = new List<LiteListViewItem> ();

        public event EventHandler<EventArgs<LiteListViewItem>> ItemDoubleClicked;
        ...
        protected override void OnDoubleClick (MouseEventArgs e)
        {
            ...
            if (clicked_item != null)
                ItemDoubleClicked?.Invoke (this, new EventArgs<LiteListViewItem> (clicked_item));
        }

        public void SetSelectedItem (LiteListViewItem item)
        {
