...
{
    public class LiteModernFormTitleBar : LiteControl
    {
        ...
        protected override void OnMouseDown (MouseEventArgs e)
        {
            ...
            if (!close_button_bounds.Contains (e.Location) && !(AllowMinimize && minimize_button_bounds.Contains (e.Location))) {
                ...
                is_dragging = true;
                drag_start_location = ParentForm.Location;
                drag_start_mouse_location = ParentForm.PointToScreen (e.Location);
            }
        }
        ...
        protected override void OnMouseMove (MouseEventArgs e)
        {
            ...
            if (is_dragging) {
                var screen = ParentForm.PointToScreen (e.Location);
                var delta_x = screen.X - drag_start_mouse_location.X;
                var delta_y = screen.Y - drag_start_mouse_location.Y;

                ParentForm.Location = new Point (drag_start_location.X + delta_x, drag_start_location.Y + delta_y);
            }
        }
