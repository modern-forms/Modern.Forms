...
namespace Modern.Forms
{
    ...
    public class LiteTabStrip : LiteControl
    {
        ...
        public List<LiteTabStripItem> Tabs { get; } = new List<LiteTabStripItem> ();

        public LiteTabStripItem SelectedTab {
        ...
        private LiteTabStripItem GetTabAtLocation (Point location) => Tabs.FirstOrDefault (tp => tp.Bounds.Contains (location));
        ...
        private void SetHover (LiteTabStripItem item)
        {
