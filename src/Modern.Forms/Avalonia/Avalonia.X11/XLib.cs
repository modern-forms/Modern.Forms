...
namespace Avalonia.X11
{
    internal unsafe static class XLib
    {
        ...
        [DllImport(libX11)]
        internal static extern IntPtr XCreateWindow(IntPtr display, IntPtr parent, int x, int y, int width, int height,
            int border_width, int depth, int xclass, IntPtr visual, UIntPtr valuemask,
            ref XSetWindowAttributes attributes);

        [DllImport(libX11)]
        internal static extern IntPtr XCreateSimpleWindow(IntPtr display, IntPtr parent, int x, int y, int width,
        ...
        [DllImport(libX11)]
        internal static extern IntPtr XNextEvent(IntPtr display, out XEvent xevent);

        [DllImport(libX11)]
        internal static extern int XConnectionNumber(IntPtr diplay);

        [DllImport(libX11)]
        internal static extern int XPending(IntPtr diplay);
        ...
        [DllImport(libX11)]
        internal static extern int XSendEvent(IntPtr display, IntPtr window, bool propagate, IntPtr event_mask,
            ref XEvent send_event);

        [DllImport(libX11)]
        internal static extern int XQueryTree(IntPtr display, IntPtr window, out IntPtr root_return,
        ...
        [DllImport(libX11)]
        internal static extern uint XConfigureWindow(IntPtr display, IntPtr window, ChangeWindowFlags value_mask,
        ...
        [DllImport(libX11)]
        internal static extern int XInternAtoms(IntPtr display, string[] atom_names, int atom_count, bool only_if_exists,
            IntPtr[] atoms);
        ...
        [DllImport(libX11)]
        internal static extern int XGrabPointer(IntPtr display, IntPtr window, bool owner_events, EventMask event_mask,
        ...
        [DllImport(libX11)]
        internal static extern bool XQueryPointer(IntPtr display, IntPtr window, out IntPtr root, out IntPtr child,
            out int root_x, out int root_y, out int win_x, out int win_y, out int keys_buttons);

        [DllImport(libX11)]
        internal static extern bool XTranslateCoordinates(IntPtr display, IntPtr src_w, IntPtr dest_w, int src_x,
            int src_y, out int intdest_x_return, out int dest_y_return, out IntPtr child_return);

        [DllImport(libX11)]
        internal static extern bool XGetGeometry(IntPtr display, IntPtr window, out IntPtr root, out int x, out int y,
            out int width, out int height, out int border_width, out int depth);

        [DllImport(libX11)]
        internal static extern bool XGetGeometry(IntPtr display, IntPtr window, IntPtr root, out int x, out int y,
        ...
        [DllImport(libX11)]
        internal static extern bool XGetGeometry(IntPtr display, IntPtr window, IntPtr root, IntPtr x, IntPtr y,
            out int width, out int height, IntPtr border_width, IntPtr depth);

        [DllImport(libX11)]
        internal static extern uint XWarpPointer(IntPtr display, IntPtr src_w, IntPtr dest_w, int src_x, int src_y,
        ...
        [DllImport(libX11)]
        internal static extern int XClearArea(IntPtr display, IntPtr window, int x, int y, int width, int height,
            bool exposures);
        ...
        [DllImport(libX11)]
        internal static extern int XLookupColor(IntPtr display, IntPtr Colormap, string Coloranem,
        ...
        [DllImport(libX11)]
        internal static extern int XSetTransientForHint(IntPtr display, IntPtr window, IntPtr parent);
        ...
        [DllImport(libX11)]
        internal static extern int XDrawRectangle(IntPtr display, IntPtr drawable, IntPtr gc, int x1, int y1, int width,
            int height);

        [DllImport(libX11)]
        internal static extern int XFillRectangle(IntPtr display, IntPtr drawable, IntPtr gc, int x1, int y1, int width,
            int height);
        ...
        [DllImport(libX11)]
        internal static extern int XCopyArea(IntPtr display, IntPtr src, IntPtr dest, IntPtr gc, int src_x, int src_y,
            int width, int height, int dest_x, int dest_y);

        [DllImport(libX11)]
        internal static extern int XGetWindowProperty(IntPtr display, IntPtr window, IntPtr atom, IntPtr long_offset,
        ...
        [DllImport(libX11)]
        internal static extern IntPtr XCreatePixmapCursor(IntPtr display, IntPtr source, IntPtr mask,
            ref XColor foreground_color, ref XColor background_color, int x_hot, int y_hot);

        [DllImport(libX11)]
        internal static extern IntPtr XCreateBitmapFromData(IntPtr display, IntPtr drawable, byte[] data, int width, int height);

        [DllImport(libX11)]
        internal static extern IntPtr XCreatePixmapFromBitmapData(IntPtr display, IntPtr drawable, byte[] data, int width,
        ...
        [DllImport(libX11)]
        internal static extern int XQueryBestCursor(IntPtr display, IntPtr drawable, int width, int height,
        ...
        [DllImport(libX11)]
        internal static extern void XGetWMNormalHints(IntPtr display, IntPtr window, ref XSizeHints hints,
        ...
        [DllImport(libX11)]
        internal static extern int XConvertSelection(IntPtr display, IntPtr selection, IntPtr target, IntPtr property,
        ...
        [DllImport(libX11)]
        internal static extern int XChangeActivePointerGrab(IntPtr display, EventMask event_mask, IntPtr cursor,
            IntPtr time);
        ...
        [DllImport(libX11)]
        internal static extern void XPeekEvent(IntPtr display, out XEvent xevent);
        
        [DllImport(libX11)]
        internal static extern void XMatchVisualInfo(IntPtr display, int screen, int depth, int klass, out XVisualInfo info);
        
        [DllImport(libX11)]
        internal static extern IntPtr XLockDisplay(IntPtr display);
        
        [DllImport(libX11)]
        internal static extern IntPtr XUnlockDisplay(IntPtr display);
        
        [DllImport(libX11)]
        internal static extern IntPtr XCreateGC(IntPtr display, IntPtr drawable, ulong valuemask, IntPtr values);
        
        [DllImport(libX11)]
        internal static extern int XInitImage(ref XImage image);
        
        [DllImport(libX11)]
        internal static extern int XDestroyImage(ref XImage image);

        [DllImport(libX11)]
        internal static extern int XPutImage(IntPtr display, IntPtr drawable, IntPtr gc, ref XImage image,
            int srcx, int srcy, int destx, int desty, uint width, uint height);
        [DllImport(libX11)]
        internal static extern int XSync(IntPtr display, bool discard);
        
        [DllImport(libX11)]
        internal static extern IntPtr XCreateColormap(IntPtr display, IntPtr window, IntPtr visual, int create);
        ...
        [DllImport (libX11)]
        internal static extern unsafe int XLookupString(ref XEvent xevent, void* buffer, int num_bytes, out IntPtr keysym, out IntPtr status);
        
        [DllImport (libX11)]
        internal static extern unsafe int Xutf8LookupString(IntPtr xic, ref XEvent xevent, void* buffer, int num_bytes, out IntPtr keysym, out IntPtr status);
        
        [DllImport (libX11)]
        internal static extern unsafe IntPtr XKeycodeToKeysym(IntPtr display, int keycode, int index);
        
        [DllImport (libX11)]
        internal static extern unsafe IntPtr XSetLocaleModifiers(string modifiers);

        [DllImport (libX11)]
        internal static extern IntPtr XOpenIM (IntPtr display, IntPtr rdb, IntPtr res_name, IntPtr res_class);

        [DllImport (libX11)]
        internal static extern IntPtr XCreateIC (IntPtr xim, string name, XIMProperties im_style, string name2, IntPtr value2, IntPtr terminator);
        
        [DllImport (libX11)]
        internal static extern IntPtr XCreateIC (IntPtr xim, string name, XIMProperties im_style, string name2, IntPtr value2, string name3, IntPtr value3, IntPtr terminator);
        
        [DllImport (libX11)]
        internal static extern void XCloseIM (IntPtr xim);

        [DllImport (libX11)]
        internal static extern void XDestroyIC (IntPtr xic);

        [DllImport(libX11)]
        internal static extern bool XQueryExtension(IntPtr display, [MarshalAs(UnmanagedType.LPStr)] string name,
            out int majorOpcode, out int firstEvent, out int firstError);

        [DllImport(libX11)]
        internal static extern bool XGetEventData(IntPtr display, void* cookie);

        [DllImport(libX11)]
        internal static extern void XFreeEventData(IntPtr display, void* cookie);
        
        [DllImport(libX11Randr)]
        internal static extern int XRRQueryExtension (IntPtr dpy,
            out int event_base_return,
            out int error_base_return);

        [DllImport(libX11Randr)]
        internal static extern int XRRQueryVersion(IntPtr dpy,
            out int major_version_return,
            out int minor_version_return);

        [DllImport(libX11Randr)]
        internal static extern XRRMonitorInfo*
            XRRGetMonitors(IntPtr dpy, IntPtr window, bool get_active, out int nmonitors);
        [DllImport(libX11Randr)]
        internal static extern void XRRSelectInput(IntPtr dpy, IntPtr window, RandrEventMask mask);

        [DllImport(libXInput)]
        internal static extern Status XIQueryVersion(IntPtr dpy, ref int major, ref int minor);

        [DllImport(libXInput)]
        internal static extern IntPtr XIQueryDevice(IntPtr dpy, int deviceid, out int ndevices_return);
        ...
        [DllImport(libXInput)]
        internal static extern Status XISelectEvents(
            IntPtr dpy,
            IntPtr win,
            XIEventMask* masks,
            int num_masks
