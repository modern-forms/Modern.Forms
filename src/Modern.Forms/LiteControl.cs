...
namespace Modern.Forms
{
    public class LiteControl : ILayoutable, IDisposable
    {
        ...
        {
            ModernDefaultLayout.Instance.Layout (this, null);
        ...
        public void PerformLayout (LiteControl affectedControl, string affectedProperty)
        {
        ...
        private MouseEventArgs MouseEventsForControl (MouseEventArgs e, LiteControl control)
        {
            if (control == null)
                return e;
        ...
        protected virtual void OnLayout (LayoutEventArgs e)
        {
            ...
            ModernDefaultLayout.Instance.Layout (this, e);
        }
        ...
        internal void SetParentInternal (LiteControl control)
        {
            parent = control;
        }
